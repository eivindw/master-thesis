...
boundary between external and embedded DLSs is not necessarily a fixed
...
parameterization (generics) of classes. Scala supports higher-order
...
parameterization to denote the type of the values in the matrix. A
...
fact that Scala allows both regular paranthesis and curly braces to
surround function arguments. Notice how the condition is given in
paranthesis, and the body statements in curly braces, although they
