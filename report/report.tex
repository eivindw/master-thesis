...
\texttt{Factory method}\footnote{TODO: Describe Factory method
  pattern} and \texttt{Builder}\footnote{TODO: Describe Builder
  pattern}, or other utility operations like the sorting shown in the
examples above. In my image analysis DSL (described in section
\vref{sec:dslimageprocessing}), singleton objects are used to
construct objects:
...
Development\footnote{TODO: Describe BDD} in a very fluent style:
...
\item Annotations -- Annotations were introduced to Java with version
  ...
  embedding DSLs.
\item Reflection -- TODO: describe
\item AOP -- TODO: describe
\end{itemize}
...
TODO: describe -- Lisp macroes + built-in metadata support
