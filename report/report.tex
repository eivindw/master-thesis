...
\begin{lstlisting}[float,caption=Matrix implementation using type parameters.,label=lst:typeparameters]
trait Matrix[T] {
...
\begin{lstlisting}[caption=Image implementation using virtual type.,label=lst:virtualtypes]
trait Image {
  type DataType
...
createAreaChart("Image Histogram", img)
\end{lstlisting}
...
% TODO: change focus to host language changes
