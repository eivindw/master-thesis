...
\lstinputlisting[float,caption=Scala ``Divide-by-zero'' compiler plugin.,label=lst:scalacompilerplugin]{../examples/scala-compiler-plugin/DivByZero.scala}
...
mapping for the \texttt{+} function. Attempting to add numbers after
this renders an error: <<\lstinline[language=]{Unable to resolve symbol: + in this context}>>.
