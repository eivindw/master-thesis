...
powerful way to create loosly coupled modular DSLs. The functional
composition techniques in Clojure provide some exiting new ways to
compose modular code, compared to the more imperative
languages. Implict conversion is a good technique found in Scala that
...
binding, all print stataments within a \texttt{noprint} macro call
will be suppressed.
