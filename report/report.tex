...
languages like Java and Scala, with the ability to instatiate and
customizing packages. The mechanism is described in detail with
examples in\cite{axe09}. This section outlines how a package template
mechanism can be utilized to combine embedded DSLs.
...
\begin{itemize}
\item Major language differences with regards to implementing embedded
  DSLs. When is dynamic language good? When is static good? When is
  functional programming smart?
\item Performance. Language differences? Common JVM things?
\end{itemize}
