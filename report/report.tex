...
\texttt{while} contruct, the plugin could simply search the abstract
syntax tree for occurences of while, and output an error message if
...
TODO: describe possibilities in Clojure (switch to ns + redef
...
The JVM supports a wide varity of tuning/configuration options that
...
% LocalWords:  toArray newArr actorexecutor ExecMsg hasResult getResult func
...
% LocalWords:  prog compilerplugins aspx dynamicmetaprogramming
