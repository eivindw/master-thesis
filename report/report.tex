...
The goal platform of this thesis is JVM. The reason for this is that
the enormous popularity of the Java programming language has made the
...
many other languages have been created (or ported) for the JVM. So
this thesis looks at how some of these languages provide various
...
and functional programming. The combination of object-orientation and
functional programming has been proved to support advanced embedding
of DSLs\cite{hof08}. The fact that the language compiles to bytecode
and uses static typing makes it similar to Java in many ways. For this
...
values directly, as with the \texttt{name} variable in this example.
