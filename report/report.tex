...
genericity\cite{moo08} and abstract type members. In this section it
is demonstrated how these features are used to make the image
processing DSL more general, allowing specializations in a number of
ways. The main reason for using these features in the image processing
DSL is to ease the process of extending with new specializations.

% TODO - integrate:
\textbf{Generics implemented with erasure} -- This was a design
...
\begin{lstlisting}[float,caption=Matrix example using type parameters.,label=lst:typeparameters]
trait Matrix[T] {
