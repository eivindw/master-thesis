...
\item Aspect Oriented Programming (AOP) -- AOP is a mechanism that can
  be used for metaprogramming. As shown in\cite{hua08}, AOP and
  metaprogramming can be useful when designing DSLs.
\end{itemize}
