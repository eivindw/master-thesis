...
\begin{figure}[h]
  ...
  \caption{Two different images together with their generated
    histograms, showing the distribution of gray levels in the
    images. It clear from the histogram that Image II uses a much
    larger part of the pixel values available, which means it has a
    higher contrast, than Image I.\label{fig:iphistogram}}
\end{figure}
