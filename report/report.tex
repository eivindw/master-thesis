...
\subsubsection{Typing -- Static/Dynamic}

\subsubsection{Paradigm -- OO/FP}
...
concise syntax. Some examples are given in the previous section about
query syntax.
...
LINQ statements show in an earlier section anonymous functions play a
...
languages like Scala there exist a series of concepts from dynamic
