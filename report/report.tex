...
example of this is shown in listing \vref{lst:javachaining}.

\begin{lstlisting}[float,caption=Java method chaining and nesting,label=lst:javachaining,language=java]
computer(
  processor(
    cores(2),
    Processor.Type.i386
